  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex flex-col">
      ...
      <div className="bg-gradient-to-r from-pink-400 to-purple-400 p-4 sm:p-6 text-center">
        <h1 className="text-xl sm:text-2xl font-bold text-white">FloMentor</h1>
        <p className="text-white/90 mt-1 text-sm sm:text-base">Welcome to your wellness journey</p>
      </div>
